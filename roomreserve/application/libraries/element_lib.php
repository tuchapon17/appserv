...
class Element_lib
{
	...
	function btn($btntype,$other_attr,$btntext='')
	{
		...
		{
			$html='<button type="button" title="จำนวนแถว" class="btn btn-info dropdown-toggle" data-toggle="dropdown" '.$other_attr.'>
		...
		{
			$html='<button type="submit" title="ค้นหา" class="btn btn-primary" '.$other_attr.'><i class="fa fa-search fa-white"></i></button>';
		}
		else if($btntype=="clear_search")//
		{
			$html='<button type="button" title="ยกเลิกการค้นหา" class="btn btn-danger" id="clearSearch" '.$other_attr.'><i class="fa fa-times fa-white"></i></button>';
		}
		else if($btntype=="submit")//
		{
			if($btntext=='')$btntext=' ตกลง';
			$html='<button type="submit" class="btn btn-primary" '.$other_attr.'><i class="fa fa-check-square-o fa-lg fa-white"></i>'.$btntext.'</button>';
		}
		...
		{
			$html='<button type="button" class="btn btn-default" '.$other_attr.' title="จัดการรูป"><i class="fa fa-picture-o fa-lg"></i></button>';
		}
