...
DEFINE('THSARA_TTF_FONT', 'THSarabunNew.ttf');
DEFINE('THSARAB_TTF_FONT', 'THSarabunNewB.ttf');
DEFINE('THSARAI_TTF_FONT', 'THSarabunNewI.ttf');
DEFINE('THSARAZ_TTF_FONT', 'THSarabunNewBI.ttf');
?>
