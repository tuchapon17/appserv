      ...
      <div class="row">
      	...
      	<?php echo $reserve_tab;?>
      		<div class="col-lg-12" id="loginform">
      		 	<br>
      		 	<form role="form" class="form-inline" action="?d=manage&c=<?=$controller?>&m=search4" method="post" autocomplete="off">
...
<!-- Custom Javascript -->
	...
	$(function(){
		...
		*/
		$("#clearSearch").click(function(){
			s_url="?d=manage&c=<?=$controller?>&m=search4";
			r_url="?d=manage&c=<?=$controller?>&m=edit4";
	...
	function select_orderby()
	{
		...
		var set_order_link="?d=manage&c=<?=$controller?>&m=set_orderby4";
		var c_main_link="?d=manage&c=<?=$controller?>&m=edit4";
	...
	function select_searchfield()
	{
		...
		select_field+='<option value="project_name">ชื่อโครงการ</option>';
		//var b_url="<?php echo base_url();?>";
		var s_link="?d=manage&c=<?=$controller?>&m=set_searchfield4";
		var c_main_link="?d=manage&c=<?=$controller?>&m=edit4";
