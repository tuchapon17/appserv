...
class Room_has_article_model extends MY_Model
{
	...
	{
		$this->set_session();
		$orderby_filed=$this->sess_orderby_room_has_article["field"];
		$orderby_type=$this->sess_orderby_room_has_article["type"];
	...
	function is_article_id_exist($article_id,$room_id)
	{
		...
		$this->db->where("tb_reserve_has_article.tb_article_id",$article_id)
